...
const BOT_GATEWAY_EXTENSION_VERSION: &str = "1.0.1";
const BOT_GATEWAY_BUNDLED_PACKAGE_FILE: &str = "bot-gateway-1.0.1.tar.gz";
...
const NEXT_AI_GATEWAY_EXTENSION_VERSION: &str = "1.0.6";
const NEXT_AI_GATEWAY_BUNDLED_PACKAGE_FILE: &str = "next-ai-gateway-1.0.6.tar.gz";
